...
const Notes = () => {
  return (
    <form className="plasmo-w-[90%] plasmo-mx-auto plasmo-flex plasmo-flex-col plasmo-gap-16 ">
      ...
      <h2 className="plasmo-font-[700] plasmo-text-[2rem] plasmo-font-sans plasmo-text-neutral-800">
        Want to write some note down from your linkedin's feed? We got you.
      </h2>
      <div className="">
        <label
          htmlFor="title"
          className="font-[700] plasmo-text-[1.75rem] plasmo-text-neutral-700  plasmo-mb-6">
          Title
        </label>
        <input
          type="text"
      ...
      <div className="">
        <label
          htmlFor="description"
          className="font-[700] plasmo-text-[1.5rem]  plasmo-text-neutral-700">
          Description
        </label>
        <textarea
          name="description"
      ...
      <div className="plasmo-flex plasmo-w-full plasmo-gap-8">
        <button
          type="button"
